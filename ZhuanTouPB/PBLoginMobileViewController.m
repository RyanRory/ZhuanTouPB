...
#import "PBLoginMobileViewController.h"

@interface PBLoginMobileViewController ()

@end

@implementation PBLoginMobileViewController
...
- (void)next:(id)sender
{
    ...
    [manager GET:URL parameters:nil success:^(AFHTTPRequestOperation *operation, NSDictionary *responseObject) {
        ...
        {
            [dataModel setMobile:[mobileTextField getTextFieldStr]];
            PBLoginPasswordViewController *vc = [[self storyboard]instantiateViewControllerWithIdentifier:@"PBLoginPasswordViewController"];
