...
@implementation PBStructuredChooseView
...
- (id)init
{
    ...
    {
        [self initTitle];
        self.buttonOnlyEngine = [[PBButtonOnlyEngine alloc]init];
        marginSides = 0;
        marginBetween = 0;
    }
...
- (void)addButtons:(NSArray*)buttonTitleArray withMarginBetween:(float)between withMarginSides:(float)sides
{
    ...
    {
        PBBorderedButton *button = [[PBBorderedButton alloc]init];
